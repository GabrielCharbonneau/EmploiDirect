...
class UsersController extends AppController {
    ...
    public function createEnterpriseAccount() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Users->save($user)) {
                ...
                $this->sendConfirmationEmail($user['email'], 'an enterprise');
    ...
    public function createCandidateAccount() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Users->save($user)) {
                ...
                $this->sendConfirmationEmail($user['email'], 'a candidate');
    ...
    public function sendConfirmationEmail($emailAdd, $role) {
        try{
            $email = new Email();
            $email->to($emailAdd);
